...
class StudentCollectionResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'father_birth_certificate_number' => $this->father_birth_certificate_number,
            'father_birth_certificate_serie_number' => $this->father_birth_certificate_serie_number,
            'father_birth_certificate_serial_number' => $this->father_birth_certificate_serial_number,
            'phone_number' => $this->phone_number,
            'mobile_number' => $this->mobile_number,
            'father_mobile_number' => $this->father_mobile_number,
            'mother_mobile_number' => $this->father_mobile_number,
            'mother_birth_certificate_number' => $this->mother_birth_certificate_number,
            'mother_birth_certificate_serie_number' => $this->mother_birth_certificate_serie_number,
            'mother_birth_certificate_serial_number' => $this->mother_birth_certificate_serial_number,
            'level' => $this->level,
